                ...
                <div class="md:grid md:grid-cols-3 md:gap-6">
                    <div class="md:col-span-1">
                        <div class="px-4 sm:px0">
                            ...
                            <p class="text-sm text-gray-600">Si editas no podrás vovler al estado anterior </p>
                        </div>
                    </div>
                    <div class="md:col-span-2 mt-5 md:mt-0">
                        <div class="shadow bg-white md:rounded-md p-4">
                            ...
                            <hr class="my-6">
                            <button class="bg-red-600 px-4 py-2 rounded-sm text-white hover:bg-red-800" @click.prevent="destroy">eliminar nota</button>
                        </div>
                    </div>
